...
entry_result = Text(window, height=10)
entry_result.insert(END, 'RESULT WILL BE SHOWN HERE')
...
label_result.grid(row=7, column=0, padx=(10, 5), pady=5, sticky="e")
...
entry_result.grid(row=7, column=1, padx=(0, 10), pady=5, sticky="we")
update_button.grid(row=12, column=1, padx=(450, 10), pady=(0, 10))
new_button.grid(row=12, column=1, padx=(600, 10), pady=(0, 10))
refresh_button.grid(row=12, column=1, padx=(300, 10), pady=(0, 10))
send_button.grid(row=12, column=1, padx=(150, 10), pady=(0, 10))
